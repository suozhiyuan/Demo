...
{
	ES_Patrol    UMETA(DisplayName = "Patrol"),		// 巡逻
	ES_Chase     UMETA(DisplayName = "Chase"),		// 追逐
	ES_Escape    UMETA(DisplayName = "Escape"),		// 逃跑
	ES_Attack    UMETA(DisplayName = "Attack"),		// 攻击
	ES_Hurt      UMETA(DisplayName = "Hurt"),		// 被击
	ES_Defence   UMETA(DisplayName = "Defence"),	// 防守
	ES_Dead      UMETA(DisplayName = "Dead")		// 死亡
};
...
{
	EA_Normal   UMETA(DisplayName = "Normal"),		// 普通攻击
	EA_Dash     UMETA(DisplayName = "Dash"),		// 冲锋状态
	EA_Pursuit  UMETA(DisplayName = "Pursuit")		// 大招
};
