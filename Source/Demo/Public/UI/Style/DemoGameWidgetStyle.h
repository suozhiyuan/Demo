...
#include "DemoGameWidgetStyle.generated.h"

/**
 * 
 */
USTRUCT()
struct DEMO_API FDemoGameStyle : public FSlateWidgetStyle
{
	GENERATED_USTRUCT_BODY()

	FDemoGameStyle();
	virtual ~FDemoGameStyle();

	// FSlateWidgetStyle
	virtual void GetResources(TArray<const FSlateBrush*>& OutBrushes) const override;
	static const FName TypeName;
	virtual const FName GetTypeName() const override { return TypeName; };
	static const FDemoGameStyle& GetDefault();
...
class UDemoGameWidgetStyle : public USlateWidgetStyleContainerBase
{
	GENERATED_BODY()
